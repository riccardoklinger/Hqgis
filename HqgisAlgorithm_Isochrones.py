...
class getIsos(QgsProcessingAlgorithm):
    def __init__(self):
        super().__init__()
    ...
    def displayName(self):
        ...
        """
        return self.tr('Get Reachability around Points')
    ...
    def shortHelpString(self):
        ...
        """
        return self.tr("""This processing algorithm supports reachability analysis for a set of points.<br> Different traffic modes are supported to determine the according travel distance:<br>'walk',[0] indicates that the user is on foot.<br>'drive',[1] indicates that the user is driving.<br>'public_transport',[2] indicates that the user is on public transport.<br>'bicycle',[3] indicates that the user is on bicycle.<br>'none',[4] if the user is neither on foot nor driving.
    ...
    def initAlgorithm(self, config=None):
        ...
        """
        print(Hqgis.hqgis.Hqgis.createIsoLayerBatch)
